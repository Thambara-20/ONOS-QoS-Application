...
ts_devserver = rule(
    ...
    attrs = {
        ...
        "devserver": attr.label(
            ...
            default = Label("//@bazel/typescript/devserver"),
            executable = True,
            cfg = "host",
        ),
        "devserver_host": attr.label(
            ...
            Defaults to precompiled go binary setup by @bazel/typescript npm package""",
            default = Label("//@bazel/typescript/devserver:devserver_%s" % host_platform),
            executable = True,
            cfg = "host",
        ),
        ...
        "_launcher_template": attr.label(allow_single_file = True, default = Label("//@bazel/typescript/internal/devserver:launcher_template.sh")),
        "_requirejs_script": attr.label(allow_single_file = True, default = Label("//@bazel/typescript/third_party/npm/requirejs:require.js")),
    },
    outputs = {
        "manifest": "%{name}.MF",
        "script": "%{name}.sh",

...
```python
load("//@bazel/typescript:index.bzl", "ts_devserver", "ts_library")
...
Defaults to `//@bazel/typescript/devserver:devserver`

#### `devserver_host`
(*[label]*): Go based devserver executable for the host platform.
            Defaults to precompiled go binary setup by @bazel/typescript npm package

Defaults to `//@bazel/typescript/devserver:devserver_darwin_amd64`

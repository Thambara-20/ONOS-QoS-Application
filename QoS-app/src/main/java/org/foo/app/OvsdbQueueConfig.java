...
import org.foo.app.OvsdbClientService;
...
import static org.foo.app.OvsdbConstant.BURST;
import static org.foo.app.OvsdbConstant.MAX_RATE;
import static org.foo.app.OvsdbConstant.MIN_RATE;
import static org.foo.app.OvsdbConstant.PRIORITY;
import static org.foo.app.OvsdbConstant.QUEUE_EXTERNAL_ID_KEY;
...
public class OvsdbQueueConfig extends AbstractHandlerBehaviour implements QueueConfigBehaviour {
    ...
    private OvsdbClientService getOvsdbClient(DriverHandler handler) {
        ...
        return (OvsdbClientService) ovsController.getOvsdbClient(nodeId);
    }
}